...
// /login - Post - receives a username and password , checks them against the database, and returns the user object if they match with a cookie including a signed JWT
